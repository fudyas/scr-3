...
`$ARGUMENTS` — optional. The branch to push (e.g. `master`, `release/v0.2-otg-2`). If empty, the target is the current branch (`git rev-parse --abbrev-ref HEAD`).
