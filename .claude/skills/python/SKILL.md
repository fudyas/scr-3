---
name: python
description: Apply the project's Python coding and documentation conventions. Auto-invoke when writing or editing Python (.py) files — covers docstrings, type hints, comment policy, signatures, and style rules.
---
