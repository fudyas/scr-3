---
name: lets-python
description: Route all Python and project-venv operations through LETS. Auto-invoke for any Python, pip, venv, or Python-driven test/script command in this repo (scripts, `-m` modules, `-c` one-liners, pytest/unittest, coverage tools).
---
