---
name: lets-node
description: Route all Node.js operations through LETS. Auto-invoke for any npm, npx, or Node-driven command in this repo (package installs, build/dev/test scripts, vitest, tsc, vite, eslint, prettier).
---
