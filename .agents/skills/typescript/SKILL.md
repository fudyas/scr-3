...
name: typescript
description: >-
  Apply the project's TypeScript coding and documentation conventions. Auto-invoke when writing or editing TypeScript (.ts/.tsx) files — covers JSDoc, types, the Result pattern, wire-type provenance, imports, naming, and style.
---
