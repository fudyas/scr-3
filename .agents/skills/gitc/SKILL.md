...
Invocation arguments are optional. If non-empty, use as commit title verbatim and weight body bullets toward that focus. If empty, derive title and body from the staged diff.
